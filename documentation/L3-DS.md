---
layout: page
permalink: /documentation/L3-DS.html
header: yes
...
<h1 align="center"><strong>Lecture 3 - Introduction to Dynamical Systems</strong></h1>
...
<br>
<p align="center"> Click <a href="https://www.epfl.ch/labs/lasa/wp-content/uploads/2024/09/lecture3-intro-to-dynamical-systems.zip" target="_blank" style="color: red;"> here </a> to download the corresponding exercise for this lecture as a zip file. <br> Note you will also need this <a href="https://www.epfl.ch/labs/lasa/wp-content/uploads/2024/09/libraries.zip" target="_blank" style="color: red;"> libraries </a> folder placed with the correct directory structure.  </p> 
